...
if (!window.s_accountName) { 
	if ((s_Host.indexOf(".dev.adobe.") != -1) || (s_Host.indexOf(".sflab.acrobat.") != -1) || (s_Host.indexOf("stage.") != -1) || (s_Host.indexOf("staging.") != -1) || (s_Host.indexOf(".sea.adobe") != -1) || (s_Host.indexOf(".corp.adobe") != -1)) {  var s_account="mxadobetest";
	}
...
s.linkInternalFilters="javascript:,adobe,macromedia,dreamweaver,flash,shockwave,sdc,markme,sdc.shockwave,infopoll,developerlocator.macromedia,adobemax2007.com,photoshop.com,acrobat.com,../"
...
function s_doPlugins(s) {
  ...
  if (s_URL.indexOf("/cfusion/designcenter/search") != -1) {
	s.prop19=s.getQueryParam('product');
	s.prop20=s.getQueryParam('topic');
	// ADC Tutorial Search
	s.prop6=s.getQueryParam('term');
  ...
  s.prop4=s.getQueryParam('devcon'); //Developer Connection featured story usage
	...
	if (s_checkGeo[1].length != 2) {
		var s_checkTC=/(\/shockwave\/download)|(get.adobe)|(adobe.com\/support)|(kb.adobe.com)|(help.adobe.com)|(\/cfusion\/support)|(acrobat.com)|(\/readstep)|(adobe.com\/eeurope\/)|(adobe.com\/be_)|(adobe.com\/ch_)|(adobe.com\/hk_)|(adobe.com\/mea\/)|(adobe.com\/lu_)|(\/cfusion\/webforums\/)|(tv.adobe)|(kuler.adobe)|(macromedia.com)/gi;
